#!/usr/bin/env python3
"""
Script to clear Streamlit cache and run the YouTube Analyzer app with the new multipage structure.
This helps prevent issues with stale cache data and ensures a clean start.
"""
import os
import sys
import shutil
...
if __name__ == "__main__":
    ...
    # Get the app file from command line or default to Home.py
    app_file = sys.argv[1] if len(sys.argv) > 1 else "Home.py"
    print(f"Running Streamlit multipage app with: {app_file}")
    ...
    try:
        ...
        try:
            ...
            print("Streamlit app stopped gracefully.")
        except subprocess.TimeoutExpired:
            process.kill()
            print("Forced termination of Streamlit app.")
